...
public class NVPAPICaller
{
    ...
    public string APIUsername = "sb-ykmff3503572@business.example.com";
    private string APIPassword = "AT-UT3CKGEehsKJA8Dyz0rxWjWjFolarFR2zpARQHZTJzzTg8xgkcbZ3qUSjXTuNv0P7GkILsV6asDxo";
    private string APISignature = "AT-UT3CKGEehsKJA8Dyz0rxWjWjFolarFR2zpARQHZTJzzTg8xgkcbZ3qUSjXTuNv0P7GkILsV6asDxo";
    ...
    public bool ShortcutExpressCheckout(string amt, ref string token, ref string retMsg)
    {
        ...
        encoder["BRANDNAME"] = "Blue Crystal Shop Sample Application";
        ...
        using (Blue_Crystal.Logic.ShoppingCartActions myCartOrders = new Blue_Crystal.Logic.ShoppingCartActions())
        {
